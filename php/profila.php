		...
		<?php
			...
			foreach($erabiltzaileak->erabiltzailea as $erabiltzailea){
				...
				if(strcmp($laguntza,$erab)==0){
					...
					<form action="" id="formularioa" name="formularioa" method="post" onsubmit="return balidatu()">
						...
						Korreoa:<input type="text" id="korreoa" name="korreoa" oninput="konprobatuKorreoa(this.value)" value="<?php echo htmlspecialchars($korreoa); ?>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" oninput="konprobatuKorreoa(this.value)" title="Emailak honako formatua eduki behar du: emaila@emaila.emaila" required></input></br>
